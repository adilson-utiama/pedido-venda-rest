...
public class AuthService {
	...
	private char randomChar() {
		...
		if(opt == 0) { 
			return (char) (rand.nextInt(10) + 48); //gera digito numerico
		} else if (opt == 1) { 
			return (char) (rand.nextInt(26) + 65); //gera caracter letra maiuscula
		} else {
			return (char) (rand.nextInt(26) + 97); //gera caracter letra minuscula
		}
	}
}
